    ...
    <head>
        ...
        <?php if($_SESSION["ID"]==-1) { ?>
            ...
            <div id="Login_Div" class="login">
                ...
                <div id="Login_Error"><?php echo $_LE; ?></div>
                ...
                <div id="Other_Manager" style="display: none;">
                    ...
                    <div id="User_Manager" style="display: none;">
                        ...
                        <div id="User_Content">Kis türelmet...</div>
                            <div id="Users_Div">
                                 <select id="Edit_User" onChange="if($(':selected',this).val()!='-'){$.post('ajax.php',{TYPE: 9, Type: $(':selected',this).val()},function(data){$('#User_Content').html(data);}); $('#Change_User').attr('disabled', false);}else $('#Change_User').attr('disabled', true);">
                                 <option value="-"> - </option>
                                 <?php
                                 $Users="";
